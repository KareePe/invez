    ...
    <section class="py-14 md:py-20 px-6 bg-white">
        <div class="max-w-6xl mx-auto">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex flex-col gap-2.5">
                                <a href="tel:0816611286"
                                    class="flex items-center gap-2.5 text-[#6b5f52] hover:text-[#1a1714] transition-colors duration-150">
                                    <i data-feather="phone" style="width:13px;height:13px;color:#c9a96e;"></i>
                                    <span class="text-sm">081-6611286</span>
                                </a>
                                <a href="tel:0818716303"
                                    class="flex items-center gap-2.5 text-[#6b5f52] hover:text-[#1a1714] transition-colors duration-150">
                                    <i data-feather="smartphone" style="width:13px;height:13px;color:#c9a96e;"></i>
                                    <span class="text-sm">081-8716303</span>
                                </a>
                                <a href="mailto:toyoelectric@gmail.com"
                                    class="flex items-center gap-2.5 text-[#6b5f52] hover:text-[#1a1714] transition-colors duration-150">
                                    <i data-feather="mail" style="width:13px;height:13px;color:#c9a96e;"></i>
                                    <span class="text-sm">toyoelectric@gmail.com</span>
                                </a>
                                <a href="https://www.invez.biz" target="_blank" rel="noopener"
                                    class="flex items-center gap-2.5 text-[#6b5f52] hover:text-[#1a1714] transition-colors duration-150">
                                    <i data-feather="globe" style="width:13px;height:13px;color:#c9a96e;"></i>
                                    <span class="text-sm">www.invez.biz · App: Invez</span>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid md:grid-cols-2 gap-3">
                ...
                <div class="fade-up border border-[#e8e4df] rounded-lg p-6 hover:border-[#c9a96e] transition-colors duration-150">
                    ...
                    <a href="tel:042326647"
                        class="flex items-center gap-2 text-[#6b5f52] hover:text-[#1a1714] transition-colors duration-150 text-sm pt-3 border-t border-[#f0ebe3]">
                        <i data-feather="phone" style="width:13px;height:13px;color:#c9a96e;"></i>
                        Tel. (042) 326647-48
                    </a>
                </div>
                ...
                <div class="fade-up border border-[#e8e4df] rounded-lg p-6 hover:border-[#c9a96e] transition-colors duration-150">
                    ...
                    <div class="flex flex-col gap-1.5 pt-3 border-t border-[#f0ebe3]">
                        <a href="tel:0816611286"
                            class="flex items-center gap-2 text-[#6b5f52] hover:text-[#1a1714] transition-colors duration-150 text-sm">
                            <i data-feather="phone" style="width:13px;height:13px;color:#c9a96e;"></i>
                            081-6611286
                        </a>
                        <a href="tel:0818716303"
