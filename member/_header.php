...
<aside class="w-56 bg-white border-r border-[#e8e4df] fixed inset-y-0 left-0 z-30 flex flex-col">
    ...
    <nav class="flex-1 px-3 py-3 space-y-0.5">
        <a href="settings.php" class="mnav-link <?= _mnav('settings') ?>">
        ...
        <a href="articles.php" class="mnav-link <?= _mnav('article-edit') || $_current === 'articles' ? 'bg-[#fdf6e8] text-[#c9a96e] font-medium' : 'text-[#6b5f52] hover:bg-[#f5f3f0] hover:text-[#1a1714]' ?>">
        ...
        <a href="properties.php" class="mnav-link <?= _mnav('property-edit') || $_current === 'properties' ? 'bg-[#fdf6e8] text-[#c9a96e] font-medium' : 'text-[#6b5f52] hover:bg-[#f5f3f0] hover:text-[#1a1714]' ?>">
